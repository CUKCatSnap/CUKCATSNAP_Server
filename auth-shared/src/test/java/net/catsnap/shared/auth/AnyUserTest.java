...
class AnyUserTest {
    ...
    void Target이_METHOD여야_한다() {
        // given
        Target target = AnyUser.class.getAnnotation(Target.class);
    ...
    void Retention이_RUNTIME이어야_한다() {
        // given
        Retention retention = AnyUser.class.getAnnotation(Retention.class);
    ...
    void Authentication_메타_어노테이션이_붙어있어야_한다() {
        // given
        Authentication authentication = AnyUser.class.getAnnotation(Authentication.class);
    ...
    void 메서드에_적용되고_리플렉션으로_읽을_수_있어야_한다() throws NoSuchMethodException {
        ...
        AnyUser annotation = method.getAnnotation(AnyUser.class);

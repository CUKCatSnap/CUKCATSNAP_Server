...
class AdminTest {
    ...
    void Target이_METHOD여야_한다() {
        // given
        Target target = Admin.class.getAnnotation(Target.class);
    ...
    void Retention이_RUNTIME이어야_한다() {
        // given
        Retention retention = Admin.class.getAnnotation(Retention.class);
    ...
    void Authentication_메타_어노테이션이_붙어있어야_한다() {
        // given
        Authentication authentication = Admin.class.getAnnotation(Authentication.class);

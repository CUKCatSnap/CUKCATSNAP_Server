...
public class PhotographerSignInAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public PhotographerSignInAuthenticationFilter(AuthenticationManager authenticationManager,
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        CatsnapAuthenticationToken beforeAuthenticationToken = new PhotographerAuthenticationToken(
            identifier,
            password);

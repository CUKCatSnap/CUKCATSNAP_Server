...
public enum ReservationResultCode implements ResultCode {
    ...
    PHOTOGRAPHER_RESERVATION_TIME_FORMAT_MAPPING_WEEKDAY(201, "SR008", "성공적으로 예약 시간 형식을 특정 요일에 등록했습니다."),
    PHOTOGRAPHER_RESERVATION_TIME_FORMAT_UNMAPPING_WEEKDAY(200, "SR009", "성공적으로 예약 시간 형식을 특정 요일에 해제했습니다."),

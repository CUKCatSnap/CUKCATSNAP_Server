...
public class ReservationController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200 SR000", description = "성공적으로 예약을 조회했습니다.", content = @Content(schema = @Schema(implementation = ReservationResponse.MyReservationList.class))),
    ...
    @GetMapping("/my")
    public ResultResponse<ReservationResponse.MyReservationList> getMyReservation(

...
public class MemberReservationController {
    ...
    public ResultResponse<SlicedData<ReservationResponse.MemberReservationInformationList>> getMyReservation(
            ...
            Pageable pageable){
        Slice<Reservation> reservationSlice = memberReservationService.getMyReservation(reservationQueryType, pageable);
        ReservationResponse.MemberReservationInformationList memberReservationInformationList = reservationConverter.toMemberReservationInformationList(reservationSlice.getContent());
